<div id="registrationOverlay" class="overlay-wrapper">
    <div class="overlay-content">
        ...
        <div class="form-section">
            <form id="registrationForm" class="relative">
                <!-- Step 1: Basic Info -->
                ...
                <button id="cancelRegistrationBtn" class="absolute z-100 bottom-0 left-2 mr-2 mt-2 bg-red-400 p-1 rounded-sm">EXIT <i class="ph ph-x-circle text-md"></i></button>
            </form>
        </div>
    </div>
</div>
